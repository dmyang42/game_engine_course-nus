...
function BlueSceneParser(sceneFilePath) {
    this.mSceneXml = gEngine.ResourceMap.retrieveAsset(sceneFilePath);
}

BlueSceneParser.prototype._getElm = function (tagElm) {
...
BlueSceneParser.prototype.parseCamera = function () {
...
BlueSceneParser.prototype.parseSquares = function (sqSet) {
