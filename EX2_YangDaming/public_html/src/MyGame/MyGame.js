...
function MyGame() {
    ...
    this.mHero = null;
    this.mSupport = null;
    this.JsonFile = "assets/Grey.json";
}
...
MyGame.prototype.initialize = function () {
    gEngine.TextFileLoader.loadTextFile(this.JsonFile, gEngine.TextFileLoader.eTextFileType.eTextFile);
    var jsonString = gEngine.ResourceMap.retrieveAsset(this.JsonFile);
